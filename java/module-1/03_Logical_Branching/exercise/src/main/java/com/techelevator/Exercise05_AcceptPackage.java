...
public class Exercise05_AcceptPackage {
    ...
    public boolean acceptPackage(int weightPounds, int lengthInches, int widthInches, int heightInches, boolean isSurchargePaid) {
        if (weightPounds <= 40 && lengthInches * widthInches * heightInches <= 6912 && lengthInches <= 66 && widthInches <= 66 && heightInches <= 66 && isSurchargePaid == false) {
            return true;
        }
        else if (weightPounds <= 40 && lengthInches * widthInches * heightInches <= 6912 && lengthInches > 66 | widthInches > 66 | heightInches > 66 && isSurchargePaid == true) {
        return true;
        }
        return false;
    }
