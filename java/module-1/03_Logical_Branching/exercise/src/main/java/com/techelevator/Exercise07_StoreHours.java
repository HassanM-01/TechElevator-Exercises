...
public class Exercise07_StoreHours {
    ...
    public boolean isStoreOpen(int currentHour, char currentDay, boolean isSummer) {
        ...
        else if (currentHour >= 8 && currentHour < 20 &&  currentDay == 'W' && isSummer == true) {
            return true;
        }
        else if (currentHour >= 9 && currentHour < 15 && currentDay == 'S' && isSummer == true) {
            return true;
        }
        else if (currentHour >= 8 && currentHour < 17 && currentDay == 'M' | currentDay == 'W' | currentDay == 'F' && isSummer == true) {
            return true;
        }
        return false;
    }
