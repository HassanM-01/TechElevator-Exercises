...
public class JdbcParkDao implements ParkDao {
    ...
    public List<Park> getParksByState(String stateAbbreviation) {
        ...
        String sql = "SELECT * FROM park JOIN park_state ON park.park_id = park_state.park_id WHERE state_abbreviation = ?";
    ...
    public void deletePark(long parkId) {
        String sqlone = "DELETE FROM park_state WHERE park_id = ?";
        String sql = "DELETE FROM park WHERE park_id = ?;";
        jdbcTemplate.update(sqlone, parkId);
